...
$(function () { ///// jQB /////////////////
    ...
    init = function () {
        ...
        // (원래 각도로 뒤집으며 투명도 1로 보이게 애니매이션 예정)
        $("#pg5 .minfo").css({
        ...
        // (원래크기와 각도로 복귀 애니매이션 예정)
        $("#pg6 .minfo").css({
            transform: "translate(-50%,-50%) scale(.4) rotate(1000deg)"
        }); //////////// css //////////////////

        // 7. 탐정홍길동 : x축 스케일을 늘려놓는다. 투명도 0
        // (원래크기와 투명도로 복귀예정)
        $("#pg7 .minfo").css({
    ...
    pageAction = function () {
        ...
        // 6. 아가씨
            ...
            $("#pg6 .minfo").css({
                ...
                transition: "all 1s cubic-bezier(0.42, 0, 0.51, 1.24) 0s"
            }); //////////// css //////////////////
        ...
        // 7. 탐정 홍길동
            ...
            $("#pg7 .minfo").css({
                ...
                opacity: 1,
                transition:"all 2s cubic-bezier(0.6, -0.12, 0.43, 1.16) 0s"
            }); /////////// css ////////////////
